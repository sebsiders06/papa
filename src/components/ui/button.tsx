...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gold text-navy shadow-gold hover:bg-gold-light hover:shadow-premium-lg active:scale-[0.98]",
        secondary:
          "bg-navy text-white hover:bg-navy-700 shadow-premium active:scale-[0.98]",
        outline:
          "border-2 border-gold text-gold bg-transparent hover:bg-gold hover:text-navy",
        ghost: "text-navy hover:bg-slate-100",
        link: "text-gold underline-offset-4 hover:underline",
        white:
          "bg-white text-navy hover:bg-slate-50 shadow-premium active:scale-[0.98]",
      },
      size: {
